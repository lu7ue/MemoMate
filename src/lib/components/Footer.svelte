...
<footer class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-300 shadow-md">
    <div class="flex justify-around items-center h-16">
        <!-- Home -->
        <button class="flex flex-col items-center text-gray-700 hover:text-black" on:click={ () => goto('/main/home') }>
        ...
        <!-- Calendar -->
        <button class="flex flex-col items-center text-gray-700 hover:text-black" on:click={ () => goto('/main/calendar') }>
            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <!-- More -->
        <button class="flex flex-col items-center text-gray-700 hover:text-black" on:click={ () => goto('/main/more') }>
            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
