...
<div class="min-h-screen bg-white px-2">
    <!-- User Info Card -->
    <div class="bg-white p-3 flex items-center justify-between rounded-2xl shadow-md">
    ...
    <!-- Settings Cards -->
    <div class="bg-white p-3 mt-4 rounded-2xl shadow-md">
        <!-- Theme Mode -->
